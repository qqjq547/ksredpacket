...
public class CodeView extends View {
    ...
    private void init(AttributeSet attrs) {
        ...
        if (attrs == null) {
            ...
            pointRadius = dpToPx(getContext(), 8);
            ...
            pointRadius = typedArray.getDimensionPixelSize(R.styleable.CodeView_pointRadius, dpToPx(getContext(), 8));
     ...
     * DP转PX
     */
    public int dpToPx(Context context, float dpSize) {
