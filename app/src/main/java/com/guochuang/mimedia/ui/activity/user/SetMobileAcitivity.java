...
import com.guochuang.mimedia.mvp.presenter.SetMobilePresenter;
...
public class SetMobileAcitivity extends MvpActivity<SetMobilePresenter> implements SetMobileView {
    ...
    @Override
    protected SetMobilePresenter createPresenter() {
        return new SetMobilePresenter(this);
    }
