...
import com.guochuang.mimedia.ui.fragment.CommentInfoFragment;
import com.guochuang.mimedia.ui.fragment.CommentRedbagFragment;

import butterknife.BindView;
import butterknife.OnClick;

public class MyCommentActivity extends MvpActivity {
    ...
    public void initViewAndData() {
        tvTitle.setText(R.string.text_my_comments);
        fragments[0] = new CommentRedbagFragment();
        fragments[1] = new CommentInfoFragment();
