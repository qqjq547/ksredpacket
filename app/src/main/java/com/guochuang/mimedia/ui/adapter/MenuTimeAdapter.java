...
public class MenuTimeAdapter extends BaseQuickAdapter<String,BaseViewHolder> {
    int selectPos=0;
    public MenuTimeAdapter(@Nullable List<String> data) {
        super(R.layout.item_menu_time,data);
    }
