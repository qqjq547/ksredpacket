...
public class CollectInfoFragment extends MvpFragment<CollectInfoPresenter> implements InfoListView {

    @BindView(R.id.rv_list)
    RecyclerView rvList;
    @BindView(R.id.srl_refresh)
    SmartRefreshLayout srlRefresh;
    List<InfoItem> itemArr=new ArrayList<>();
    InfoAdapter adapter;
    int curPage=1;
