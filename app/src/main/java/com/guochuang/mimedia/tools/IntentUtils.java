...
public class IntentUtils {
    ...
    public static void startPurchaseActivity(Activity activity, int purchaseType,long snatchId,int unitPrice,int payNumber,String money,int lockDay) {
        ...
        intent.putExtra(Constant.LOCKDAY,lockDay);
